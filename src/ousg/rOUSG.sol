...
import "src/external/openzeppelin/contracts/token/IERC20.sol";
import "src/external/openzeppelin/contracts-upgradeable/token/ERC20/IERC20Upgradeable.sol";
import "src/external/openzeppelin/contracts-upgradeable/token/ERC20/IERC20MetadataUpgradeable.sol";
import "src/external/openzeppelin/contracts-upgradeable/proxy/Initializable.sol";
import "src/external/openzeppelin/contracts-upgradeable/utils/ContextUpgradeable.sol";
import "src/external/openzeppelin/contracts-upgradeable/security/PausableUpgradeable.sol";
import "src/external/openzeppelin/contracts-upgradeable/access/AccessControlEnumerableUpgradeable.sol";
import "src/kyc/KYCRegistryClientUpgradeable.sol";
import "src/rwaOracles/IRWAOracle.sol";
  ...
  IERC20MetadataUpgradeable
{
   ...
   * @dev The `_amount` argument is the amount of tokens, not shares.
   */
   //@audit should be able to transfer even when paused, but approve prevents it?
